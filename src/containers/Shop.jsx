...
const Shop = ({
    ...
    const onChangeCategory = (e, catId) => {
      setFormData({ ...formData, [e.target.name]: catId})
    }
          ...
          <section aria-labelledby="products-heading" className="pt-6 pb-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <form onSubmit={e=>onSubmit(e)} className="hidden lg:block">
                <h3 className="sr-only">Categories</h3>
                <div role="list" className="text-sm font-medium text-gray-900 space-y-4 pb-6 border-b border-gray-200">
                {
                        categories &&
                        categories !== null &&
                        categories !== undefined &&
